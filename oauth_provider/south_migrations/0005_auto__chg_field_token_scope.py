...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('oauth_provider_token', 'scope_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oauth_provider.Scope'], null=True))

    def backwards(self, orm):

        # Changing field 'Token.scope'
        db.alter_column('oauth_provider_token', 'scope_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['oauth_provider.Scope']))
    ...
    models = {
        ...
        'oauth_provider.token': {
            ...
            'scope': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['oauth_provider.Scope']", 'null': 'True', 'blank': 'True'}),
